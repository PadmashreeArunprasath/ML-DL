...
mae_scores = [4181.19, 2518.95]
rmse_scores = [5796.28, 4542.80]
...
# 4. Distribution of Insurance Charges
axes[1, 1].hist(df['charges'], bins=30, alpha=0.7, color='green', edgecolor='black')
axes[1, 1].set_xlabel('Insurance Charges ($)')
axes[1, 1].set_ylabel('Frequency')
axes[1, 1].set_title('Distribution of Insurance Charges')
